...
*** Test Cases ***
Associated Oil Reservation Ticket
...
# Associated Ticket
    Click Element    xpath://input[@class=" button button--success add_oil_prod_button"]
    Click Button    xpath://div[@id="pagination_product_list_buttons"]//button[2]
    Click Button    xpath://tbody[@id="product_table_list_body"]//tr[2]//button
    Click Button    xpath://button[@class="btn btn-success save_added_pro_in_sess mx-2"]
    Scroll Element Into View    id:oil_reset
    Sleep     2s
