...
Associated Reservation Ticket
    ...
    Input Text    id:caller_info    Renzo
...
#    Associated Ticket
    Scroll Element Into View    xpath://div[@class="tab-head wells-tab"]
    Select From List By Value       id:fuel_types    4
    Input Text    name:gallons    50
